...
Original file is located at
    https://colab.research.google.com/drive/1qRQFrgAWDw9fv4TThmPRxbum6sdtziJW
"""
...
# From paper the sequence of Architecture C (CIFAR/Keras-Inspired architecture):
# 1.  2D conv of size 9x9, filter depth= 3, number= 32, padding = 'same' stride=1
# 2.  ReLU Activation
# 3.  2D conv of size 9x9, depth=32, num = 32, padding ='Valid', stride =1
# 4.  ReLU Activation
# 5.  Max Pool of size 6x6, depth= 32, stride= 6
# 6.  Dropout--0.25
# 7.  2D conv of size 9x9, depth=32, num = 64, padding ='Same', stride =1
# 8.  ReLU Activation
# 9.  2D conv of size 9x9, depth=64, num = 64, padding ='Valid', stride =1
# 10. ReLU Activation
# 11. Max Pool of size 6x6, depth= 640, stride= 6
# 12. Dropout--0.25
# 13. Flatten
# 14. Dense Number of filters = 512
# 15. ReLU Activation
# 16. Dropout--0.5
# 17. Dense Number of filters = 2
# 18.Softmax

# Define parameters for Architecture C
strides1 = (6, 6)
...
# model.save(ArchC_model.h5)
model.summary()

model.save_weights("./ArchC_model.h5")

model.save("./archi_C", include_optimizer=True)
...
with open("./ArchC_model.json", "w") as json_file:
    json_file.write(model_json)

from keras.models import model_from_json

# opening and storing file in a variable
json_file = open('./ArchC_model.json', 'r')
...
mymodel.load_weights("./ArchC_model.h5")
